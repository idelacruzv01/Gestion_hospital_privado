...
<html lang="es">
    ...
    <body>
        ...
        <main>
            ...
            <h1>Buscador de Precios Privados</h1>

            <section class="buscador">
                <input type="text" id="buscarPrecio" placeholder="Buscar el precio de un servicio o prueba privado...">
            </section>

            <section id="resultado_precios" class="resultado_precios">
